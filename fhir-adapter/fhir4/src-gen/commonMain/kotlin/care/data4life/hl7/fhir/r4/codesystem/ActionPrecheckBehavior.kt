...
enum class ActionPrecheckBehavior {
     ...
     * action occurs. The system displaying the action to the end user should consider
    ...
    /**
     * An action with this behavior is one of the less frequent actions included by the
     * end user, for the particular context in which the action occurs. The system
     * displaying the actions to the end user would typically not "pre-check" such an
     * action.
     */
    @SerialName("no")
    NO,
