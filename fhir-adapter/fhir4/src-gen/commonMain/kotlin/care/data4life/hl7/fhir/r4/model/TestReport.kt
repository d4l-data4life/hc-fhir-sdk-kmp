...
import care.data4life.hl7.fhir.r4.codesystem.TestReportActionResult
import care.data4life.hl7.fhir.r4.codesystem.TestReportParticipantType
...
data class TestReport(
    ...
    companion object {
        @JvmStatic
        fun resourceType(): String = "TestReport"
    }
}
...
data class TestReportParticipant(
    ...
    companion object {
        @JvmStatic
        fun resourceType(): String = "TestReportParticipant"
    }
}
...
data class TestReportSetup(
    ...
    companion object {
        @JvmStatic
        fun resourceType(): String = "TestReportSetup"
    }
}
...
data class TestReportSetupAction(
    ...
    companion object {
        @JvmStatic
        fun resourceType(): String = "TestReportSetupAction"
    }
}
...
data class TestReportSetupActionAssert(
    ...
    companion object {
        @JvmStatic
        fun resourceType(): String = "TestReportSetupActionAssert"
    }
}
...
data class TestReportSetupActionOperation(
    ...
    companion object {
        @JvmStatic
        fun resourceType(): String = "TestReportSetupActionOperation"
    }
}
...
data class TestReportTeardown(
    ...
    companion object {
        @JvmStatic
        fun resourceType(): String = "TestReportTeardown"
    }
}
...
data class TestReportTeardownAction(
    ...
    companion object {
        @JvmStatic
        fun resourceType(): String = "TestReportTeardownAction"
    }
}
...
data class TestReportTest(
    ...
    companion object {
        @JvmStatic
        fun resourceType(): String = "TestReportTest"
    }
}
...
data class TestReportTestAction(
    ...
    companion object {
        @JvmStatic
        fun resourceType(): String = "TestReportTestAction"
    }
}
