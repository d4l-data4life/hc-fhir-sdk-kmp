...
class NutritionOrderFhirTest {
    ...
    fun testNutritionOrder01() {
        // Given
        val sourceJson = loadAsString("stu3/nutritionorder-example-diabeticsupplement.json")
    ...
    private fun assertNutritionOrder01Step01(data: NutritionOrder) {
        ...
        assertEquals(
            expected = "http://hl7.org/fhir/diet",
        ...
        assertEquals(
            expected = NutritionOrderStatus.ACTIVE,
            actual = data.status
        )
    ...
    fun testNutritionOrder02() {
        // Given
        val sourceJson = loadAsString("stu3/nutritionorder-example-enteralbolus.json")
    ...
    private fun assertNutritionOrder02Step01(data: NutritionOrder) {
        ...
        assertEquals(
            expected = "http://hl7.org/fhir/entformula-additive",
        ...
        assertEquals(
            expected = "http://usextension/snomed.info/sct",
    ...
    fun testNutritionOrder03() {
        // Given
        val sourceJson = loadAsString("stu3/nutritionorder-example-fiberrestricteddiet.json")
    ...
    fun testNutritionOrder04() {
        // Given
        val sourceJson = loadAsString("stu3/nutritionorder-example-texture-modified.json")
    ...
    fun testNutritionOrder05() {
        // Given
        val sourceJson = loadAsString("stu3/nutritionorder-example-pureeddiet-simple.json")
    ...
    fun testNutritionOrder06() {
        // Given
        val sourceJson = loadAsString("stu3/nutritionorder-example-infantenteral.json")
    ...
    fun testNutritionOrder07() {
        // Given
        val sourceJson = loadAsString("stu3/nutritionorder-example-enteralcontinuous.json")
    ...
    fun testNutritionOrder08() {
        // Given
        val sourceJson = loadAsString("stu3/nutritionorder-example-cardiacdiet.json")
    ...
    fun testNutritionOrder09() {
        // Given
        val sourceJson = loadAsString("stu3/nutritionorder-example-pureeddiet.json")
    ...
    fun testNutritionOrder10() {
        // Given
        val sourceJson = loadAsString("stu3/nutritionorder-example-diabeticdiet.json")
