Pod::Spec.new do |spec|
    spec.name                     = 'library'
    spec.version                  = '0.0.1'
    spec.homepage                 = 'https://github.com/gesundheitscloud/d4l-kotlin-mpp-library-template'
    spec.source                   = { :git => "Not Published", :tag => "Cocoapods/#{spec.name}/#{spec.version}" }
    spec.authors                  = ''
    spec.license                  = ''
    spec.summary                  = 'Kotlin multiplatforn library template'
