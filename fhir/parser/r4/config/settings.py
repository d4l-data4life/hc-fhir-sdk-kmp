...
tpl_resource_source = 'template-resource.kt'                # the template to use as source when writing resource implementations for profiles
...
manual_profiles = [
    ('templates/Placeholder.kt', None, [
        'date', 'dateTime', 'time', 'instant',
    ]),
    ('templates/Base64Binary.kt', None, [
        'base64Binary',
    ]),
    ('templates/FhirBoolean.kt', None, [
        'boolean',
    ]),
    ('templates/FHIRDecimal.kt', None, [
        'decimal',
    ]),
    ('templates/FHIRInteger.kt', None, [
