...
class CarePlanFhirTest {
    ...
    private fun assertCarePlan01Step01(data: CarePlan) {
        assertEquals(
            expected = "procedure",
            actual = data.activity?.get(0)?.detail?.category?.coding?.get(0)?.code
                ?.replace("\\n", " ")
        )

        assertEquals(
            expected = "http://hl7.org/fhir/care-plan-activity-category",
            actual = data.activity?.get(0)?.detail?.category?.coding?.get(0)?.system
                ?.replace("\\n", " ")
        )
        ...
        assertEquals(
            ...
            actual = data.activity?.get(0)?.detail?.prohibited?.value
        )
        ...
        assertEquals(
            expected = CarePlanStatus.COMPLETED,
            actual = data.status
        )
    ...
    private fun assertCarePlan02Step01(data: CarePlan) {
        ...
        assertEquals(
            expected = CarePlanStatus.ACTIVE,
            actual = data.status
        )
    ...
    private fun assertCarePlan04Step01(data: CarePlan) {
        ...
        assertEquals(
            ...
            actual = data.activity?.get(0)?.detail?.statusReason
                ?.replace("\\n", " ")
        )
        ...
        assertEquals(
            expected = "A PlanDefinition protocol for obesity",
    ...
    private fun assertCarePlan05Step01(data: CarePlan) {
        ...
        assertEquals(
            expected = "observation",
            actual = data.activity?.get(1)?.detail?.category?.coding?.get(0)?.code
                ?.replace("\\n", " ")
        )

        assertEquals(
            expected = "http://hl7.org/fhir/care-plan-activity-category",
            actual = data.activity?.get(1)?.detail?.category?.coding?.get(0)?.system
                ?.replace("\\n", " ")
        )
        ...
        assertEquals(
            expected = "False".toBoolean(),
            actual = data.activity?.get(1)?.detail?.prohibited?.value
        )
        ...
        assertEquals(
            expected = CarePlanIntent.PROPOSAL,
            actual = data.intent
        )
    ...
    private fun assertCarePlan07Step01(data: CarePlan) {
        ...
        assertEquals(
            expected = "other",
            actual = data.activity?.get(2)?.detail?.category?.coding?.get(0)?.code
                ?.replace("\\n", " ")
        )

        assertEquals(
            expected = "http://hl7.org/fhir/care-plan-activity-category",
            actual = data.activity?.get(2)?.detail?.category?.coding?.get(0)?.system
                ?.replace("\\n", " ")
        )
        ...
        assertEquals(
            expected = "False".toBoolean(),
            actual = data.activity?.get(2)?.detail?.prohibited?.value
        )
        ...
        assertEquals(
            expected = "other",
            actual = data.activity?.get(3)?.detail?.category?.coding?.get(0)?.code
                ?.replace("\\n", " ")
        )

        assertEquals(
            expected = "http://hl7.org/fhir/care-plan-activity-category",
            actual = data.activity?.get(3)?.detail?.category?.coding?.get(0)?.system
                ?.replace("\\n", " ")
        )
        ...
        assertEquals(
            expected = "False".toBoolean(),
            actual = data.activity?.get(3)?.detail?.prohibited?.value
        )
        ...
        assertEquals(
            expected = "other",
            actual = data.activity?.get(4)?.detail?.category?.coding?.get(0)?.code
                ?.replace("\\n", " ")
        )

        assertEquals(
            expected = "http://hl7.org/fhir/care-plan-activity-category",
            actual = data.activity?.get(4)?.detail?.category?.coding?.get(0)?.system
                ?.replace("\\n", " ")
        )
        ...
        assertEquals(
            expected = "False".toBoolean(),
            actual = data.activity?.get(4)?.detail?.prohibited?.value
        )
        ...
        assertEquals(
            expected = "other",
            actual = data.activity?.get(5)?.detail?.category?.coding?.get(0)?.code
                ?.replace("\\n", " ")
        )

        assertEquals(
            expected = "http://hl7.org/fhir/care-plan-activity-category",
            actual = data.activity?.get(5)?.detail?.category?.coding?.get(0)?.system
                ?.replace("\\n", " ")
        )

        assertEquals(
            expected = "Eve will us a calendar to check off after medications are taken",
        ...
        assertEquals(
            expected = "False".toBoolean(),
            actual = data.activity?.get(5)?.detail?.prohibited?.value
        )
        ...
        assertEquals(
            expected = "other",
            actual = data.activity?.get(6)?.detail?.category?.coding?.get(0)?.code
                ?.replace("\\n", " ")
        )

        assertEquals(
            expected = "http://hl7.org/fhir/care-plan-activity-category",
            actual = data.activity?.get(6)?.detail?.category?.coding?.get(0)?.system
                ?.replace("\\n", " ")
        )
        ...
        assertEquals(
            expected = "False".toBoolean(),
            actual = data.activity?.get(6)?.detail?.prohibited?.value
        )
        ...
        assertEquals(
            expected = "other",
            actual = data.activity?.get(7)?.detail?.category?.coding?.get(0)?.code
                ?.replace("\\n", " ")
        )

        assertEquals(
            expected = "http://hl7.org/fhir/care-plan-activity-category",
            actual = data.activity?.get(7)?.detail?.category?.coding?.get(0)?.system
                ?.replace("\\n", " ")
        )
        ...
        assertEquals(
            expected = "False".toBoolean(),
            actual = data.activity?.get(7)?.detail?.prohibited?.value
        )
        ...
        assertEquals(
            expected = "other",
            actual = data.activity?.get(8)?.detail?.category?.coding?.get(0)?.code
                ?.replace("\\n", " ")
        )

        assertEquals(
            expected = "http://hl7.org/fhir/care-plan-activity-category",
            actual = data.activity?.get(8)?.detail?.category?.coding?.get(0)?.system
                ?.replace("\\n", " ")
        )
        ...
        assertEquals(
            expected = "False".toBoolean(),
            actual = data.activity?.get(8)?.detail?.prohibited?.value
        )
    ...
    private fun assertCarePlan07Step02(data: CarePlan) {
        ...
        assertEquals(
            expected = "other",
            actual = data.activity?.get(9)?.detail?.category?.coding?.get(0)?.code
                ?.replace("\\n", " ")
        )

        assertEquals(
            expected = "http://hl7.org/fhir/care-plan-activity-category",
            actual = data.activity?.get(9)?.detail?.category?.coding?.get(0)?.system
                ?.replace("\\n", " ")
        )
        ...
        assertEquals(
            expected = "False".toBoolean(),
            actual = data.activity?.get(9)?.detail?.prohibited?.value
        )
