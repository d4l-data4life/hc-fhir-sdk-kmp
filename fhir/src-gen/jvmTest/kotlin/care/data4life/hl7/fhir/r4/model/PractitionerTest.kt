...
class PractitionerTest {
    ...
    fun testPractitioner2() {
        ...
        assertEquals("http://snomed.info/sct", data.qualification?.get(0)?.code?.coding?.get(0)?.system)
        assertEquals(ContactPointSystem.PHONE, data.telecom?.get(0)?.system)
        assertEquals(ContactPointUse.WORK, data.telecom?.get(0)?.use)
        assertEquals("+31715269111", data.telecom?.get(0)?.value)
        assertEquals(NarrativeStatus.GENERATED, data.text?.status)
    ...
    fun testPractitioner5() {
        ...
        assertEquals("urn:ietf:bcp:47", data.communication?.get(0)?.coding?.get(0)?.system)
        assertEquals(AdministrativeGender.MALE, data.gender)
    ...
    fun testPractitioner7() {
        ...
        assertEquals("Bachelor of Science", data.qualification?.get(0)?.code?.coding?.get(0)?.display)
        assertEquals("http://terminology.hl7.org/CodeSystem/v2-0360/2.7", data.qualification?.get(0)?.code?.coding?.get(0)?.system)
        assertEquals("Bachelor of Science", data.qualification?.get(0)?.code?.text)
        assertEquals("http://example.org/UniversityIdentifier", data.qualification?.get(0)?.identifier?.get(0)?.system)
    ...
    fun testPractitioner10() {
        ...
        assertEquals("http://healthcare.example.org/identifiers/staff", data.identifier?.get(0)?.system)
        assertEquals(IdentifierUse.OFFICIAL, data.identifier?.get(0)?.use)
