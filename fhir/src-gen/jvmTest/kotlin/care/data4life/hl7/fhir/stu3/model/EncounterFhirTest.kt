...
import care.data4life.hl7.fhir.stu3.codesystem.EncounterLocationStatus
import care.data4life.hl7.fhir.stu3.codesystem.EncounterStatus
...
class EncounterFhirTest {
    ...
    fun testEncounter01() {
        // Given
        val sourceJson = loadAsString("stu3/encounter-example-home.json")
    ...
    fun testEncounter02() {
        // Given
        val sourceJson = loadAsString("stu3/encounter-example-f201-20130404.json")
    ...
    fun testEncounter03() {
        // Given
        val sourceJson = loadAsString("stu3/encounter-example-f003-abscess.json")
    ...
    private fun assertEncounter03Step01(data: Encounter) {
        ...
        assertEquals(
            expected = "http://hl7.org/fhir/StructureDefinition/encounter-primaryDiagnosis",
            actual = data.reason?.get(0)?.extension?.get(0)?.url
                ?.replace("\\n", " ")
        )

        assertEquals(
            expected = "1".toLong(),
            actual = data.reason?.get(0)?.extension?.get(0)?.valuePositiveInt?.value
        )
    ...
    fun testEncounter04() {
        // Given
        val sourceJson = loadAsString("stu3/encounter-example.json")
    ...
    fun testEncounter05() {
        // Given
        val sourceJson = loadAsString("stu3/encounter-example-f002-lung.json")
    ...
    fun testEncounter06() {
        // Given
        val sourceJson = loadAsString("stu3/encounter-example-f203-20130311.json")
    ...
    private fun assertEncounter06Step01(data: Encounter) {
        ...
        assertEquals(
            expected = "DD",
            actual = data.diagnosis?.get(1)?.role?.coding?.get(0)?.code
                ?.replace("\\n", " ")
        )

        assertEquals(
            expected = "Discharge diagnosis",
            actual = data.diagnosis?.get(1)?.role?.coding?.get(0)?.display
                ?.replace("\\n", " ")
        )

        assertEquals(
            expected = "http://hl7.org/fhir/diagnosis-role",
            actual = data.diagnosis?.get(1)?.role?.coding?.get(0)?.system
                ?.replace("\\n", " ")
        )
        ...
        assertEquals(
            expected = "http://hl7.org/fhir/encounter-special-arrangements",
        ...
        assertEquals(
            expected = "http://hl7.org/fhir/v3/EncounterSpecialCourtesy",
        ...
        assertEquals(
            expected = "ReferralRequest/example",
            actual = data.incomingReferral?.get(0)?.reference
                ?.replace("\\n", " ")
        )
    ...
    fun testEncounter07() {
        // Given
        val sourceJson = loadAsString("stu3/encounter-example-xcda.json")
    ...
    fun testEncounter08() {
        // Given
        val sourceJson = loadAsString("stu3/encounter-example-f202-20130128.json")
    ...
    fun testEncounter09() {
        // Given
        val sourceJson = loadAsString("stu3/encounter-example-emerg.json")
    ...
    private fun assertEncounter09Step01(data: Encounter) {
        ...
        assertEquals(
            expected = "http://hl7.org/fhir/admit-source",
            actual = data.hospitalization?.admitSource?.coding?.get(0)?.system
                ?.replace("\\n", " ")
        )
    ...
    fun testEncounter10() {
        // Given
        val sourceJson = loadAsString("stu3/encounter-example-f001-heart.json")
