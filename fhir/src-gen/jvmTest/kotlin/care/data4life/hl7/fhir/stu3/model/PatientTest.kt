...
class PatientTest {
    ...
    fun testPatient08() {
        ...
        assertEquals(
            "1974-12-25",
            data.address?.get(0)?.period?.start?.value.toString()
        )
        assertEquals(
            "3999",
            data.address?.get(0)?.postalCode
        ...
        assertEquals(
            ...
            data.address?.get(0)?.text
        )
        assertEquals(
            AddressType.BOTH,
            data.address?.get(0)?.type
        )
        assertEquals(
            AddressUse.HOME,
            data.address?.get(0)?.use
        ...
        assertEquals(
            "Rainbow",
            data.contact?.get(0)?.address?.district
        )
        assertEquals(
            "534 Erewhon St",
        ...
        assertEquals(
            "1974-12-25",
            data.contact?.get(0)?.address?.period?.start?.value.toString()
        )
        assertEquals(
            "3999",
        ...
        assertEquals(
            "Vic",
            data.contact?.get(0)?.address?.state
        )
        assertEquals(
            AddressType.BOTH,
            data.contact?.get(0)?.address?.type
        )
        assertEquals(
            AddressUse.HOME,
            data.contact?.get(0)?.address?.use
        )
        assertEquals(
            AdministrativeGender.FEMALE,
            data.contact?.get(0)?.gender
        )
        assertEquals(
            "du Marché",
            data.contact?.get(0)?.name?.family
        ...
        assertEquals(
            "2012",
            data.contact?.get(0)?.period?.start?.value.toString()
        )
        assertEquals(
            "N",
            data.contact?.get(0)?.relationship?.get(0)?.coding?.get(0)?.code
        ...
        assertEquals(
            "Windsor",
            data.name?.get(2)?.family
        )
        assertEquals(
            "Peter",
            data.name?.get(2)?.given?.get(0)
        )
        assertEquals(
            "James",
            data.name?.get(2)?.given?.get(1)
        )
        assertEquals(
            "2002",
            data.name?.get(2)?.period?.end?.value.toString()
        )
        assertEquals(
            NameUse.MAIDEN,
            data.name?.get(2)?.use
        ...
        assertEquals(
            "2014",
            data.telecom?.get(3)?.period?.end?.value.toString()
        )
        assertEquals(
            ContactPointSystem.PHONE,
