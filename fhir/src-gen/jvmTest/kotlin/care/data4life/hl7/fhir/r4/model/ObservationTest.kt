...
class ObservationTest {
    ...
    fun testObservation01() {
        ...
        assertEquals(
            "LA6684-0",
            data.extension?.get(2)?.valueCodeableConcept?.coding?.get(0)?.code
        )
        assertEquals(
            "somatic",
            data.extension?.get(2)?.valueCodeableConcept?.coding?.get(0)?.display
        )
        assertEquals(
            "http://loinc.org",
            data.extension?.get(2)?.valueCodeableConcept?.coding?.get(0)?.system
        )
        assertEquals(
            "example-genetics-1",
            data.id
    ...
    fun testObservation05() {
        ...
        assertEquals(
            ...
            data.derivedFrom?.get(1)?.reference
        )
        assertEquals(
            "http://hl7.org/fhir/StructureDefinition/observation-geneticsGene",
            data.extension?.get(0)?.url
    ...
    fun testObservation07() {
        ...
        assertEquals(
            "Patient1 with Breast Cancer FamilyHistory",
            data.subject?.display
        )
        assertEquals(
            "Patient/brcapat",
