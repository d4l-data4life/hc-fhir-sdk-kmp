...
class MediaFhirTest {
    ...
    fun testMedia01() {
        // Given
        val sourceJson = loadAsString("stu3/media-example.json")
    ...
    private fun assertMedia01Step01(data: Media) {
        ...
        assertEquals(
            expected = "http://hl7.org/fhir/media-subtype",
            actual = data.subtype?.coding?.get(0)?.system
                ?.replace("\\n", " ")
        )

        assertEquals(
            expected = "<div xmlns=\"http://www.w3.org/1999/xhtml\">Diagram for Patient Henry Levin (MRN 12345):<br/><img src=\"#11\" alt=\"diagram\"/></div>",
        ...
        assertEquals(
            expected = DigitalMediaType.PHOTO,
            actual = data.type
        )
    ...
    fun testMedia02() {
        // Given
        val sourceJson = loadAsString("stu3/media-example-dicom.json")
    ...
    private fun assertMedia02Step01(data: Media) {
        ...
        assertEquals(
            expected = "1.2.840.11361907579238403408700.3.0.14.19970327150033",
            actual = data.id
                ?.replace("\\n", " ")
        )
        ...
        assertEquals(
            expected = "urn:oid:1.2.840.11361907579238403408700.3.0.14.19970327150033",
    ...
    fun testMedia03() {
        // Given
        val sourceJson = loadAsString("stu3/media-example-xray.json")
    ...
    private fun assertMedia03Step01(data: Media) {
        ...
        assertEquals(
            ...
            actual = data.subtype?.coding?.get(0)?.display
                ?.replace("\\n", " ")
        )
    ...
    fun testMedia04() {
        // Given
        val sourceJson = loadAsString("stu3/media-example-sound.json")
    ...
    private fun assertMedia04Step01(data: Media) {
        ...
        assertEquals(
            expected = DigitalMediaType.VIDEO,
            actual = data.type
        )
    }
}
