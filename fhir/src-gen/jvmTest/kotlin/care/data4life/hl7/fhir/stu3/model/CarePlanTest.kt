...
class CarePlanTest {
    ...
    fun testCarePlan01() {
        ...
        assertEquals(
            "procedure",
            data.activity?.get(0)?.detail?.category?.coding?.get(0)?.code
        )
        assertEquals(
        ...
        assertEquals(
            "True".toBoolean(),
            data.activity?.get(0)?.detail?.prohibited?.value
        )
        assertEquals(
    ...
    fun testCarePlan04() {
        ...
        assertEquals(
            "A PlanDefinition protocol for obesity",
    ...
    fun testCarePlan05() {
        ...
        assertEquals(
            "observation",
            data.activity?.get(1)?.detail?.category?.coding?.get(0)?.code
        )
        assertEquals(
            "http://hl7.org/fhir/care-plan-activity-category",
        ...
        assertEquals(
            "False".toBoolean(),
            data.activity?.get(1)?.detail?.prohibited?.value
        )
        assertEquals(
            CarePlanActivityStatus.COMPLETED,
    ...
    fun testCarePlan07() {
        ...
        assertEquals(
            "other",
            data.activity?.get(2)?.detail?.category?.coding?.get(0)?.code
        )
        assertEquals(
            "http://hl7.org/fhir/care-plan-activity-category",
        ...
        assertEquals(
            "False".toBoolean(),
            data.activity?.get(2)?.detail?.prohibited?.value
        )
        assertEquals(
            "2012-09-10",
        ...
        assertEquals(
            "other",
            data.activity?.get(3)?.detail?.category?.coding?.get(0)?.code
        )
        assertEquals(
            "http://hl7.org/fhir/care-plan-activity-category",
        ...
        assertEquals(
            "False".toBoolean(),
            data.activity?.get(3)?.detail?.prohibited?.value
        )
        assertEquals(
            "2012-08-27",
        ...
        assertEquals(
            "other",
            data.activity?.get(4)?.detail?.category?.coding?.get(0)?.code
        )
        assertEquals(
            "http://hl7.org/fhir/care-plan-activity-category",
        ...
        assertEquals(
            "False".toBoolean(),
            data.activity?.get(4)?.detail?.prohibited?.value
        )
        assertEquals(
            "2012-07-23",
        ...
        assertEquals(
            "other",
            data.activity?.get(5)?.detail?.category?.coding?.get(0)?.code
        )
        assertEquals(
            "http://hl7.org/fhir/care-plan-activity-category",
        ...
        assertEquals(
            "False".toBoolean(),
            data.activity?.get(5)?.detail?.prohibited?.value
        )
        assertEquals(
            "2012-07-23",
        ...
        assertEquals(
            "other",
            data.activity?.get(6)?.detail?.category?.coding?.get(0)?.code
        )
        assertEquals(
            "http://hl7.org/fhir/care-plan-activity-category",
        ...
        assertEquals(
            "False".toBoolean(),
            data.activity?.get(6)?.detail?.prohibited?.value
        )
        assertEquals(
            "2012-07-23",
        ...
        assertEquals(
            "other",
            data.activity?.get(7)?.detail?.category?.coding?.get(0)?.code
        )
        assertEquals(
            "http://hl7.org/fhir/care-plan-activity-category",
        ...
        assertEquals(
            "False".toBoolean(),
            data.activity?.get(7)?.detail?.prohibited?.value
        )
        assertEquals(
            "2012-07-10",
        ...
        assertEquals(
            "other",
            data.activity?.get(8)?.detail?.category?.coding?.get(0)?.code
        )
        assertEquals(
            "http://hl7.org/fhir/care-plan-activity-category",
        ...
        assertEquals(
            "False".toBoolean(),
            data.activity?.get(8)?.detail?.prohibited?.value
        )
        assertEquals(
            "2012-07-23",
        ...
        assertEquals(
            "other",
            data.activity?.get(9)?.detail?.category?.coding?.get(0)?.code
        )
        assertEquals(
            "http://hl7.org/fhir/care-plan-activity-category",
        ...
        assertEquals(
            "False".toBoolean(),
            data.activity?.get(9)?.detail?.prohibited?.value
        )
        assertEquals(
            "2012-07-10",
