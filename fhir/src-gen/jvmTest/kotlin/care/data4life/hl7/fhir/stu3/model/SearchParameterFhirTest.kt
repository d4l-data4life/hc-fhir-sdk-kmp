...
class SearchParameterFhirTest {
    ...
    fun testSearchParameter01() {
        // Given
        val sourceJson = loadAsString("stu3/searchparameter-example-extension.json")
    ...
    fun testSearchParameter02() {
        // Given
        val sourceJson = loadAsString("stu3/searchparameter-example-reference.json")
    ...
    fun testSearchParameter03() {
        // Given
        val sourceJson = loadAsString("stu3/searchparameter-example.json")
