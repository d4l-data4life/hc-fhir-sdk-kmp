...
class QuestionnaireTest {
    ...
    fun testQuestionnaire3() {
        ...
        assertEquals("#verbal", data.item?.get(0)?.options?.reference)
        ...
        assertEquals("#motor", data.item?.get(1)?.options?.reference)
        ...
        assertEquals("#eye", data.item?.get(2)?.options?.reference)
