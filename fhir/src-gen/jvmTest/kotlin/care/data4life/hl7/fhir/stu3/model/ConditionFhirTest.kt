...
class ConditionFhirTest {
    ...
    private fun assertCondition01Step01(data: Condition) {
        ...
        assertEquals(
            expected = ConditionVerificationStatus.CONFIRMED,
    ...
    private fun assertCondition02Step01(data: Condition) {
        ...
        assertEquals(
            expected = "http://hl7.org/fhir/condition-category",
        ...
        assertEquals(
            expected = "Roel's encounter on March eleventh",
    ...
    private fun assertCondition05Step01(data: Condition) {
        ...
        assertEquals(
            expected = "258219007",
            actual = data.stage?.summary?.coding?.get(0)?.code
                ?.replace("\\n", " ")
        )

        assertEquals(
            expected = "stage II",
            actual = data.stage?.summary?.coding?.get(0)?.display
                ?.replace("\\n", " ")
        )

        assertEquals(
            expected = "http://snomed.info/sct",
            actual = data.stage?.summary?.coding?.get(0)?.system
                ?.replace("\\n", " ")
        )
    ...
    private fun assertCondition06Step01(data: Condition) {
        ...
        assertEquals(
            expected = ConditionVerificationStatus.DIFFERENTIAL,
            actual = data.verificationStatus
        )
    }
    ...
    private fun assertCondition07Step01(data: Condition) {
        ...
        assertEquals(
            ...
            actual = data.stage?.assessment?.get(0)?.display
                ?.replace("\\n", " ")
        )
