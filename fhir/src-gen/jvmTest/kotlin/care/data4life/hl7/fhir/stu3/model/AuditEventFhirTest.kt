...
class AuditEventFhirTest {
    ...
    fun testAuditEvent01() {
        // Given
        val sourceJson = loadAsString("stu3/audit-event-example-search.json")
    ...
    private fun assertAuditEvent01Step01(data: AuditEvent) {
        ...
        assertEquals(
            expected = "95",
            actual = data.agent?.get(0)?.userId?.value
                ?.replace("\\n", " ")
        )
        ...
        assertEquals(
            expected = "2.16.840.1.113883.4.2|2.16.840.1.113883.4.2",
            actual = data.agent?.get(1)?.userId?.value
                ?.replace("\\n", " ")
        )
        ...
        assertEquals(
            expected = "http://hl7.org/fhir/object-role",
        ...
        assertEquals(
            expected = "http://hl7.org/fhir/object-type",
        ...
        assertEquals(
            ...
            actual = data.source?.identifier?.value
                ?.replace("\\n", " ")
        )
        ...
        assertEquals(
            expected = "http://hl7.org/fhir/security-source-type",
        ...
        assertEquals(
            expected = "http://hl7.org/fhir/audit-event-type",
    ...
    fun testAuditEvent02() {
        // Given
        val sourceJson = loadAsString("stu3/audit-event-example-logout.json")
    ...
    fun testAuditEvent03() {
        // Given
        val sourceJson = loadAsString("stu3/audit-event-example-vread.json")
    ...
    private fun assertAuditEvent03Step01(data: AuditEvent) {
        ...
        assertEquals(
            expected = "http://hl7.org/fhir/dicom-audit-lifecycle",
        ...
        assertEquals(
            ...
            actual = data.entity?.get(0)?.reference?.reference
                ?.replace("\\n", " ")
        )
    ...
    fun testAuditEvent04() {
        // Given
        val sourceJson = loadAsString("stu3/audit-event-example-media.json")
    ...
    private fun assertAuditEvent04Step01(data: AuditEvent) {
        ...
        assertEquals(
            ...
            actual = data.entity?.get(0)?.identifier?.value
                ?.replace("\\n", " ")
        )
        ...
        assertEquals(
            ...
            actual = data.entity?.get(1)?.identifier?.type?.coding?.get(0)?.code
                ?.replace("\\n", " ")
        )

        assertEquals(
            expected = "submission set classificationNode",
            actual = data.entity?.get(1)?.identifier?.type?.coding?.get(0)?.display
                ?.replace("\\n", " ")
        )

        assertEquals(
            expected = "urn:uuid:a54d6aa5-d40d-43f9-88c5-b4633d873bdd",
            actual = data.entity?.get(1)?.identifier?.type?.coding?.get(0)?.system
                ?.replace("\\n", " ")
        )

        assertEquals(
            expected = "e3cdfc81a0d24bd^^^&2.16.840.1.113883.4.2&ISO",
            actual = data.entity?.get(1)?.identifier?.value
                ?.replace("\\n", " ")
        )
        ...
        assertEquals(
            ...
            actual = data.entity?.get(2)?.reference?.reference
                ?.replace("\\n", " ")
        )
    ...
    fun testAuditEvent05() {
        // Given
        val sourceJson = loadAsString("stu3/audit-event-example-login.json")
    ...
    fun testAuditEvent06() {
        // Given
        val sourceJson = loadAsString("stu3/audit-event-example-pixQuery.json")
    ...
    private fun assertAuditEvent06Step01(data: AuditEvent) {
        ...
        assertEquals(
            ...
            actual = data.entity?.get(1)?.detail?.get(0)?.value
                ?.replace("\\n", " ")
        )
    ...
    fun testAuditEvent07() {
        // Given
        val sourceJson = loadAsString("stu3/auditevent-example.json")
    ...
    private fun assertAuditEvent07Step01(data: AuditEvent) {
        ...
        assertEquals(
            expected = "SNO",
            actual = data.entity?.get(0)?.identifier?.type?.coding?.get(0)?.code
                ?.replace("\\n", " ")
        )

        assertEquals(
            expected = "http://hl7.org/fhir/identifier-type",
            actual = data.entity?.get(0)?.identifier?.type?.coding?.get(0)?.system
                ?.replace("\\n", " ")
        )

        assertEquals(
            expected = "Dell Serial Number",
            actual = data.entity?.get(0)?.identifier?.type?.text
                ?.replace("\\n", " ")
        )
    ...
    fun testAuditEvent08() {
        // Given
        val sourceJson = loadAsString("stu3/auditevent-example-disclosure.json")
    ...
    private fun assertAuditEvent08Step01(data: AuditEvent) {
        ...
        assertEquals(
            expected = "SomeIdiot@nowhere.com",
            actual = data.agent?.get(0)?.userId?.value
                ?.replace("\\n", " ")
        )
        ...
        assertEquals(
            ...
            actual = data.agent?.get(1)?.reference?.reference
                ?.replace("\\n", " ")
        )
        ...
        assertEquals(
            expected = "Patient/example/_history/1",
            actual = data.entity?.get(1)?.reference?.reference
                ?.replace("\\n", " ")
        )
