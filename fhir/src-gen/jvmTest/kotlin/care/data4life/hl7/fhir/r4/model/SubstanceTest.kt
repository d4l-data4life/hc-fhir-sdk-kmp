...
class SubstanceTest {
    ...
    fun testSubstance1() {
        ...
        assertEquals("http://terminology.hl7.org/CodeSystem/substance-category", data.category?.get(0)?.coding?.get(0)?.system)
        ...
        assertEquals("http://acme.org/identifiers/substances/lot", data.instance?.get(0)?.identifier?.system)
    ...
    fun testSubstance2() {
        ...
        assertEquals("Amoxicillin + clavulanate potassium 875mg/125mg tablet (product)", data.code?.coding?.get(0)?.display)
        assertEquals("http://snomed.info/sct", data.code?.coding?.get(0)?.system)
        ...
        assertEquals("http://unitsofmeasure.org", data.ingredient?.get(0)?.quantity?.denominator?.system)
        assertEquals("mg", data.ingredient?.get(0)?.quantity?.denominator?.unit)
        assertEquals("1000".toDouble(), data.ingredient?.get(0)?.quantity?.denominator?.value?.value)
        assertEquals("mg", data.ingredient?.get(0)?.quantity?.numerator?.code)
        assertEquals("http://unitsofmeasure.org", data.ingredient?.get(0)?.quantity?.numerator?.system)
        ...
        assertEquals("http://unitsofmeasure.org", data.ingredient?.get(1)?.quantity?.denominator?.system)
        assertEquals("mg", data.ingredient?.get(1)?.quantity?.denominator?.unit)
        assertEquals("1000".toDouble(), data.ingredient?.get(1)?.quantity?.denominator?.value?.value)
        assertEquals("mg", data.ingredient?.get(1)?.quantity?.numerator?.code)
        assertEquals("http://unitsofmeasure.org", data.ingredient?.get(1)?.quantity?.numerator?.system)
