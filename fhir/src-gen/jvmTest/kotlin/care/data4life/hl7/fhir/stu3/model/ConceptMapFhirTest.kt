...
class ConceptMapFhirTest {
    ...
    fun testConceptMap01() {
        // Given
        val sourceJson = loadAsString("stu3/conceptmap-example.json")
    ...
    private fun assertConceptMap01Step01(data: ConceptMap) {
        ...
        assertEquals(
            expected = "http://hl7.org/fhir/v3/AddressUse",
        ...
        assertEquals(
            expected = "http://hl7.org/fhir/ValueSet/v3-AddressUse",
    ...
    fun testConceptMap02() {
        // Given
        val sourceJson = loadAsString("stu3/conceptmap-example-2.json")
    ...
    private fun assertConceptMap02Step01(data: ConceptMap) {
        ...
        assertEquals(
            expected = "some-code",
            actual = data.group?.get(0)?.element?.get(0)?.target?.get(0)?.dependsOn?.get(0)?.code
                ?.replace("\\n", " ")
        )
        ...
        assertEquals(
            expected = "http://example.org/fhir/DataElement/example",
    ...
    fun testConceptMap03() {
        // Given
        val sourceJson = loadAsString("stu3/conceptmap-example-specimen-type.json")
    ...
    private fun assertConceptMap03Step01(data: ConceptMap) {
        ...
        assertEquals(
            expected = "47002008",
            actual = data.group?.get(0)?.element?.get(1)?.target?.get(0)?.product?.get(0)?.code
                ?.replace("\\n", " ")
        )
        ...
        assertEquals(
            expected = "7970006",
            actual = data.group?.get(0)?.element?.get(3)?.target?.get(0)?.product?.get(0)?.code
                ?.replace("\\n", " ")
        )
        ...
        assertEquals(
            expected = "81723002",
            actual = data.group?.get(0)?.element?.get(4)?.target?.get(0)?.product?.get(0)?.code
                ?.replace("\\n", " ")
        )
        ...
        assertEquals(
            expected = "14766002",
            actual = data.group?.get(0)?.element?.get(8)?.target?.get(0)?.product?.get(0)?.code
                ?.replace("\\n", " ")
        )
        ...
        assertEquals(
            expected = "http://hl7.org/fhir/ValueSet/v2-0487",
            actual = data.sourceReference?.reference
                ?.replace("\\n", " ")
        )
        ...
        assertEquals(
            expected = "http://snomed.info/id?fhir_vs",
            actual = data.targetReference?.reference
                ?.replace("\\n", " ")
        )
