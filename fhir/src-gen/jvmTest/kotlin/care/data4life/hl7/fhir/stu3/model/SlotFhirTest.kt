...
class SlotFhirTest {
    ...
    fun testSlot01() {
        // Given
        val sourceJson = loadAsString("stu3/slot-example-busy.json")
    ...
    fun testSlot02() {
        // Given
        val sourceJson = loadAsString("stu3/slot-example.json")
    ...
    private fun assertSlot02Step01(data: Slot) {
        ...
        assertEquals(
            expected = "http://hl7.org/fhir/v2/0276",
    ...
    fun testSlot03() {
        // Given
        val sourceJson = loadAsString("stu3/slot-example-unavailable.json")
    ...
    fun testSlot04() {
        // Given
        val sourceJson = loadAsString("stu3/slot-example-tentative.json")
