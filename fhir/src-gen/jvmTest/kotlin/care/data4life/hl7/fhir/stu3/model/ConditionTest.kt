...
class ConditionTest {
    ...
    fun testCondition01() {
        ...
        assertEquals(
            "2012-02-20",
            data.assertedDate?.value.toString()
        )
        assertEquals(
            "P. van de Heuvel",
    ...
    fun testCondition02() {
        ...
        assertEquals(
            "Roel's encounter on March eleventh",
    ...
    fun testCondition05() {
        ...
        assertEquals(
            "258219007",
            data.stage?.summary?.coding?.get(0)?.code
        )
        assertEquals(
            "stage II",
            data.stage?.summary?.coding?.get(0)?.display
        )
        assertEquals(
            "http://snomed.info/sct",
            data.stage?.summary?.coding?.get(0)?.system
        )
        assertEquals(
            "P. van de Heuvel",
            data.subject?.display
    ...
    fun testCondition07() {
        ...
        assertEquals(
            ...
            data.stage?.assessment?.get(0)?.display
        )
        assertEquals(
            "14803004",
            data.stage?.summary?.coding?.get(0)?.code
