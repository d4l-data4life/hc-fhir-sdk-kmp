...
class LocationFhirTest {
    ...
    fun testLocation01() {
        // Given
        val sourceJson = loadAsString("stu3/location-example.json")
    ...
    private fun assertLocation01Step01(data: Location) {
        ...
        assertEquals(
            expected = "http://hl7.org/fhir/StructureDefinition/location-alias",
        ...
        assertEquals(
            expected = "http://hl7.org/fhir/location-physical-type",
    ...
    fun testLocation02() {
        // Given
        val sourceJson = loadAsString("stu3/location-example-room.json")
    ...
    private fun assertLocation02Step01(data: Location) {
        ...
        assertEquals(
            expected = "http://hl7.org/fhir/v2/0116",
    ...
    fun testLocation03() {
        // Given
        val sourceJson = loadAsString("stu3/location-example-ambulance.json")
    ...
    fun testLocation04() {
        // Given
        val sourceJson = loadAsString("stu3/location-example-ukpharmacy.json")
    ...
    fun testLocation05() {
        // Given
        val sourceJson = loadAsString("stu3/location-example-patients-home.json")
    ...
    fun testLocation06() {
        // Given
        val sourceJson = loadAsString("stu3/location-example-hl7hq.json")
