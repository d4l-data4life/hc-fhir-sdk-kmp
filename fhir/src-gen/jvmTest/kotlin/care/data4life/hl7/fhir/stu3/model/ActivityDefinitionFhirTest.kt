...
class ActivityDefinitionFhirTest {
    ...
    fun testActivityDefinition01() {
        // Given
        val sourceJson = loadAsString("stu3/activitydefinition-predecessor-example.json")
    ...
    private fun assertActivityDefinition01Step01(data: ActivityDefinition) {
        ...
        assertEquals(
            expected = ResourceType.REFERRALREQUEST,
            actual = data.kind
        )
    ...
    fun testActivityDefinition02() {
        // Given
        val sourceJson = loadAsString("stu3/activitydefinition-procedurerequest-example.json")
    ...
    private fun assertActivityDefinition02Step01(data: ActivityDefinition) {
        ...
        assertEquals(
            expected = ResourceType.PROCEDUREREQUEST,
            actual = data.kind
        )
    ...
    fun testActivityDefinition03() {
        // Given
        val sourceJson = loadAsString("stu3/activitydefinition-medicationorder-example.json")
    ...
    private fun assertActivityDefinition03Step01(data: ActivityDefinition) {
        ...
        assertEquals(
            ...
            actual = data.dynamicValue?.get(0)?.description
                ?.replace("\\n", " ")
        )

        assertEquals(
            expected = "3",
            actual = data.dynamicValue?.get(0)?.expression
                ?.replace("\\n", " ")
        )

        assertEquals(
            expected = "text/cql",
            actual = data.dynamicValue?.get(0)?.language
                ?.replace("\\n", " ")
        )
        ...
        assertEquals(
            ...
            actual = data.dynamicValue?.get(1)?.description
                ?.replace("\\n", " ")
        )

        assertEquals(
            expected = "30 '{tbl}'",
            actual = data.dynamicValue?.get(1)?.expression
                ?.replace("\\n", " ")
        )

        assertEquals(
            expected = "text/cql",
            actual = data.dynamicValue?.get(1)?.language
                ?.replace("\\n", " ")
        )
        ...
        assertEquals(
            expected = ResourceType.MEDICATIONREQUEST,
            actual = data.kind
        )
    ...
    fun testActivityDefinition04() {
        // Given
        val sourceJson = loadAsString("stu3/activitydefinition-example.json")
    ...
    fun testActivityDefinition05() {
        // Given
        val sourceJson = loadAsString("stu3/activitydefinition-supplyrequest-example.json")
    ...
    private fun assertActivityDefinition05Step01(data: ActivityDefinition) {
        ...
        assertEquals(
            expected = ResourceType.SUPPLYREQUEST,
            actual = data.kind
        )
        ...
        assertEquals(
            ...
            actual = data.transform?.reference
                ?.replace("\\n", " ")
        )
    }
}
