...
class ProcedureTest {
    ...
    fun testProcedure01() {
        ...
        assertEquals(
            "310512001",
            data.performer?.get(0)?.role?.coding?.get(0)?.code
        )
        assertEquals(
            "Medical oncologist",
            data.performer?.get(0)?.role?.coding?.get(0)?.display
        )
        assertEquals(
            "http://snomed.info/sct",
    ...
    fun testProcedure02() {
        ...
        assertEquals(
            "398254007",
            data.notDoneReason?.coding?.get(0)?.code
        )
        assertEquals(
            "  Pre-eclampsia (disorder)",
            data.notDoneReason?.coding?.get(0)?.display
        )
        assertEquals(
            "http://snomed.info/sct",
            data.notDoneReason?.coding?.get(0)?.system
        )
        assertEquals(
            "Pre-eclampsia",
            data.notDoneReason?.text
        )
        assertEquals(
            "Carla Espinosa",
            data.performer?.get(0)?.actor?.display
    ...
    fun testProcedure05() {
        ...
        assertEquals(
            "Care role",
            data.performer?.get(0)?.role?.text
        )
        assertEquals(
