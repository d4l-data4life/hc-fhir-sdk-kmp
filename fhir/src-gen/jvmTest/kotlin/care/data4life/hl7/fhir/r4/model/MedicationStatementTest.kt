...
class MedicationStatementTest {
    ...
    fun testMedicationStatement01() {
        ...
        assertEquals(
            "2015-02-22",
            data.dateAsserted?.value.toString()
        )
        assertEquals(
            "2014-01-23",
        ...
        assertEquals(
            "Donald Duck",
            data.informationSource?.display
        )
        assertEquals(
            "Patient/pat1",
            data.informationSource?.reference
        )
        assertEquals(
            "27658006",
            data.medicationCodeableConcept?.coding?.get(0)?.code
        )
        assertEquals(
            "Amoxicillin (product)",
            data.medicationCodeableConcept?.coding?.get(0)?.display
        )
        assertEquals(
            "http://snomed.info/sct",
            data.medicationCodeableConcept?.coding?.get(0)?.system
        )
        assertEquals(
            "HTEST",
        ...
        assertEquals(
            MedicationStatementStatusCodes.ENTERED_IN_ERROR,
            data.status
        )
        assertEquals(
            "Donald Duck",
    ...
    fun testMedicationStatement02() {
        ...
        assertEquals(
            "False".toBoolean(),
            data.dosage?.get(0)?.asNeededBoolean?.value
        )
        assertEquals(
            "d",
            data.dosage?.get(0)?.maxDosePerPeriod?.denominator?.code
        )
        assertEquals(
            "http://unitsofmeasure.org",
            data.dosage?.get(0)?.maxDosePerPeriod?.denominator?.system
        )
        assertEquals(
            "1".toDouble(),
            data.dosage?.get(0)?.maxDosePerPeriod?.denominator?.value?.value
        )
        assertEquals(
            "385055001",
            data.dosage?.get(0)?.maxDosePerPeriod?.numerator?.code
        )
        assertEquals(
            "http://snomed.info/sct",
            data.dosage?.get(0)?.maxDosePerPeriod?.numerator?.system
        )
        assertEquals(
            "capsules",
            data.dosage?.get(0)?.maxDosePerPeriod?.numerator?.unit
        )
        assertEquals(
            "3".toDouble(),
            data.dosage?.get(0)?.maxDosePerPeriod?.numerator?.value?.value
        )
        assertEquals(
            "260548002",
        ...
        assertEquals(
            "http://snomed.info/sct",
            data.dosage?.get(0)?.route?.coding?.get(0)?.system
        )
        assertEquals(
        ...
        assertEquals(
            "Patient indicates they miss the occasional dose",
            data.note?.get(0)?.text
        )
        assertEquals(
        ...
        assertEquals(
            MedicationStatementStatusCodes.ACTIVE,
            data.status
        )
        assertEquals(
            "Donald Duck",
    ...
    fun testMedicationStatement03() {
        ...
        assertEquals(
            "tab",
            data.dosage?.get(0)?.doseAndRate?.get(0)?.doseQuantity?.code
        )
        assertEquals(
            "http://terminology.hl7.org/CodeSystem/v3-orderableDrugForm",
            data.dosage?.get(0)?.doseAndRate?.get(0)?.doseQuantity?.system
        )
        assertEquals(
            "tab",
        ...
        assertEquals(
            "1".toInt(),
            data.dosage?.get(0)?.sequence?.value
        )
        assertEquals(
            "1 tablet per day",
            data.dosage?.get(0)?.text
    ...
    fun testMedicationStatement05() {
        ...
        assertEquals(
            ...
            data.derivedFrom?.get(0)?.reference
        )
        assertEquals(
            "Taking at bedtime",
            data.dosage?.get(0)?.additionalInstruction?.get(0)?.text
        )
        assertEquals(
            "32914008",
            data.dosage?.get(0)?.asNeededCodeableConcept?.coding?.get(0)?.code
        )
        assertEquals(
            "Restless Legs",
            data.dosage?.get(0)?.asNeededCodeableConcept?.coding?.get(0)?.display
        )
        assertEquals(
            "http://snomed.info/sct",
            data.dosage?.get(0)?.asNeededCodeableConcept?.coding?.get(0)?.system
        )
        assertEquals(
            "TAB",
            data.dosage?.get(0)?.doseAndRate?.get(0)?.doseRange?.high?.code
        )
        assertEquals(
            "http://terminology.hl7.org/CodeSystem/v3-orderableDrugForm",
            data.dosage?.get(0)?.doseAndRate?.get(0)?.doseRange?.high?.system
        )
        assertEquals(
            "TAB",
            data.dosage?.get(0)?.doseAndRate?.get(0)?.doseRange?.high?.unit
        )
        assertEquals(
            "2".toDouble(),
            data.dosage?.get(0)?.doseAndRate?.get(0)?.doseRange?.high?.value?.value
        )
        assertEquals(
            "TAB",
            data.dosage?.get(0)?.doseAndRate?.get(0)?.doseRange?.low?.code
        )
        assertEquals(
            "http://terminology.hl7.org/CodeSystem/v3-orderableDrugForm",
            data.dosage?.get(0)?.doseAndRate?.get(0)?.doseRange?.low?.system
        )
        assertEquals(
            "TAB",
            data.dosage?.get(0)?.doseAndRate?.get(0)?.doseRange?.low?.unit
        )
        assertEquals(
            "1".toDouble(),
            data.dosage?.get(0)?.doseAndRate?.get(0)?.doseRange?.low?.value?.value
        )
        assertEquals(
            "ordered",
            data.dosage?.get(0)?.doseAndRate?.get(0)?.type?.coding?.get(0)?.code
        ...
        assertEquals(
            "http://www.bmc.nl/portal/medstatements",
    ...
    fun testMedicationStatement07() {
        ...
        assertEquals(
            "Father indicates they miss the occasional dose",
            data.note?.get(0)?.text
        )
        assertEquals(
            MedicationStatementStatusCodes.ACTIVE,
