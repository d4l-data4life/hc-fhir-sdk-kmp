...
class DocumentReferenceTest {
    ...
    fun testDocumentReference01() {
        ...
        assertEquals(
            ...
            data.clazz?.coding?.get(0)?.code
        )
        assertEquals(
            "History and Physical",
            data.clazz?.coding?.get(0)?.display
        )
        assertEquals(
        ...
        assertEquals(
            "Encounter/xcda",
            data.context?.encounter?.reference
        )
        assertEquals(
            "T-D8200",
        ...
        assertEquals(
            "Patient/xcda",
            data.context?.related?.get(0)?.ref?.reference
        )
        assertEquals(
            "Patient/xcda",
