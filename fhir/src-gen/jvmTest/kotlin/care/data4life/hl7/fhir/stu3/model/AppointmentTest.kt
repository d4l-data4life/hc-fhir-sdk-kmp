...
class AppointmentTest {
    ...
    fun testAppointment01() {
        // Given
        val sourceJson = loadAsString("stu3/appointment-example.json")
    ...
    private fun assertAppointment01Step01(data: Appointment) {
        ...
        assertEquals(
            expected = "http://example.org/appointment-type",
        ...
        assertEquals(
            ...
            actual = data.indication?.get(0)?.display
                ?.replace("\\n", " ")
        )

        assertEquals(
            expected = "Condition/example",
            actual = data.indication?.get(0)?.reference
                ?.replace("\\n", " ")
        )
        ...
        assertEquals(
            expected = "gp",
            actual = data.serviceCategory?.coding?.get(0)?.code
                ?.replace("\\n", " ")
        )

        assertEquals(
            expected = "General Practice",
            actual = data.serviceCategory?.coding?.get(0)?.display
                ?.replace("\\n", " ")
        )

        assertEquals(
            expected = "http://example.org/service-category",
            actual = data.serviceCategory?.coding?.get(0)?.system
                ?.replace("\\n", " ")
        )
        ...
        assertEquals(
            expected = "http://example.org/specialty",
    ...
    fun testAppointment02() {
        // Given
        val sourceJson = loadAsString("stu3/appointment-example-request.json")
    ...
    fun testAppointment03() {
        // Given
        val sourceJson = loadAsString("stu3/appointment-example2doctors.json")
