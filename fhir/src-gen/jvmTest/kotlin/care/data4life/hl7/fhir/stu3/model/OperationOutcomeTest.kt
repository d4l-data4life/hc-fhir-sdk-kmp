...
class OperationOutcomeTest {
    ...
    fun testOperationOutcome01() {
        // Given
        val sourceJson = loadAsString("stu3/operationoutcome-example-validationfail.json")
    ...
    fun testOperationOutcome02() {
        // Given
        val sourceJson = loadAsString("stu3/operationoutcome-example-break-the-glass.json")
    ...
    fun testOperationOutcome03() {
        // Given
        val sourceJson = loadAsString("stu3/operationoutcome-example-searchfail.json")
    ...
    fun testOperationOutcome04() {
        // Given
        val sourceJson = loadAsString("stu3/operationoutcome-example-exception.json")
    ...
    fun testOperationOutcome05() {
        // Given
        val sourceJson = loadAsString("stu3/operationoutcome-example.json")
    ...
    fun testOperationOutcome06() {
        // Given
        val sourceJson = loadAsString("stu3/operationoutcome-example-allok.json")
