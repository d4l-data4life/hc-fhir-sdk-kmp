...
class CareTeamTest {
    ...
    fun testCareTeam1() {
        ...
        assertEquals("LA27976-2", data.category?.get(0)?.coding?.get(0)?.code)
        assertEquals("Encounter-focused care team", data.category?.get(0)?.coding?.get(0)?.display)
        assertEquals("http://loinc.org", data.category?.get(0)?.coding?.get(0)?.system)
        ...
        assertEquals("responsiblePerson", data.participant?.get(0)?.role?.get(0)?.text)
        ...
        assertEquals("adviser", data.participant?.get(1)?.role?.get(0)?.text)
