...
interface FhirDocumentManifest : FhirDomainResource {
     ...
     * Items in manifest.
     */
    val content: kotlin.collections.List<Reference>
...
data class DocumentManifest(
    ...
    @SerialName("content")
    override val content: kotlin.collections.List<Reference>,
    ...
    companion object {
        @JvmStatic
        fun resourceType(): String = "DocumentManifest"
    }
}
...
data class DocumentManifestRelated(
    ...
    companion object {
        @JvmStatic
        fun resourceType(): String = "DocumentManifestRelated"
    }
}
