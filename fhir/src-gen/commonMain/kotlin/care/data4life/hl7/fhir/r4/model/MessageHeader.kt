...
data class MessageHeader(
    ...
    companion object {
        @JvmStatic
        fun resourceType(): String = "MessageHeader"
    }
}
...
data class MessageHeaderDestination(
    ...
    companion object {
        @JvmStatic
        fun resourceType(): String = "MessageHeaderDestination"
    }
}
...
data class MessageHeaderResponse(
    ...
    companion object {
        @JvmStatic
        fun resourceType(): String = "MessageHeaderResponse"
    }
}
...
data class MessageHeaderSource(
    ...
    companion object {
        @JvmStatic
        fun resourceType(): String = "MessageHeaderSource"
    }
}
