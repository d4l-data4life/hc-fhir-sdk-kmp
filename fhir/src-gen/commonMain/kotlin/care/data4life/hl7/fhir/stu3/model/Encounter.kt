...
data class Encounter(
    ...
    @SerialName("class")
    override val clazz: Coding? = null,
    ...
    override val appointment: Reference? = null,
 ...
 * encounter, then transisions into an inpatient scenario. Doing this and not restarting a new
 * encounter ensures that any lab/diagnostic results can more easily follow the patient and not require
 * re-processing and not get lost or cancelled during a kindof discharge from emergency to inpatient.
 *
