...
enum class ResearchStudyPhase {
     ...
     * Investigational New Drug (IND) Studies. Formerly called Phase 0.
     */
    ...
    /**
     * Includes controlled clinical studies conducted to evaluate the effectiveness of
     * the drug for a particular indication or indications in participants with the
    ...
    /**
     * Includes trials conducted after preliminary evidence suggesting effectiveness of
    ...
    /**
     * Studies of FDA-approved drugs to delineate additional information including the
