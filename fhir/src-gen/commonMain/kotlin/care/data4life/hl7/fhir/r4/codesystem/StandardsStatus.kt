...
enum class StandardsStatus {
     ...
     * sufficiently reviewed to be safe for implementation. It may have known issues or
     * still be in the "in development" stage. It is included in the publication as a
     * place-holder, to solicit feedback from the implementation community and/or to
     * give implementers some insight as to functionality likely to be included in
     * future versions of the specification. Content at this level should only be
     * implemented by the brave or desperate and is very much "use at your own risk".
     * The content that is Draft that will usually be elevated to Trial Use once review
     * and correction is complete after it has been subjected to ballot.
     */
    @SerialName("draft")
    DRAFT,

    /**
     * This content has been subject to review and production implementation in a wide
     * variety of environments. The content is considered to be stable and has been
     * 'locked', subjecting it to FHIR Inter-version Compatibility Rules. While changes
     * are possible, they are expected to be infrequent and are tightly constrained.
     * Compatibility Rules.
     */
    ...
    /**
     * This content has been well reviewed and is considered by the authors to be ready
    ...
    /**
     * This is content that is managed outside the FHIR Specification, but included for
