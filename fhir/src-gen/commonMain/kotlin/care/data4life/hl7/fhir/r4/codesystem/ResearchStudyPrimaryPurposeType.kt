...
enum class ResearchStudyPrimaryPurposeType {
    ...
    /**
     * One or more interventions are being evaluated for treating a disease, syndrome,
     * or condition.
     */
    ...
    /**
     * One or more interventions are being assessed for preventing the development of a
    ...
    /**
     * One or more interventions are evaluated for maximizing comfort, minimizing side
     * effects, or mitigating against a decline in the participant's health or
     * function.
     */
    ...
    /**
     * One or more interventions are assessed or examined for identifying a condition,
     * or risk factors for a condition, in people who are not yet known to have the
