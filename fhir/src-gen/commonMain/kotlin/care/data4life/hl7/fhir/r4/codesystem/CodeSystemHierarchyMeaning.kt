...
enum class CodeSystemHierarchyMeaning {
    ...
    /**
     * No particular relationship between the concepts can be assumed, except what can
    ...
    /**
     * A hierarchy where the child concepts have an IS-A relationship with the parents
     * - that is, all the properties of the parent are also true for its child
     * concepts. Not that is-a is a property of the concepts, so additional subsumption
     * relationships may be defined using properties or the [subsumes](extension-
     ...
     * presumption that the code system is a "closed world" meaning all things must be
