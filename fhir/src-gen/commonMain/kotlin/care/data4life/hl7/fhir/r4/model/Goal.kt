...
interface FhirGoal : FhirDomainResource {
    ...
    /**
     * in-progress | improving | worsening | no-change | achieved | sustaining | not-
     * achieved | no-progress | not-attainable.
     */
...
interface FhirGoalTarget : FhirBackboneElement {
     ...
     * The target value to be achieved.
     */
    val detailBoolean: Bool?

    /**
     * The target value to be achieved.
     */
    val detailInteger: Integer?

    /**
     * The target value to be achieved.
     */
    val detailRatio: Ratio?
...
data class GoalTarget(
    ...
    companion object {
        @JvmStatic
        fun resourceType(): String = "GoalTarget"
    }
}
