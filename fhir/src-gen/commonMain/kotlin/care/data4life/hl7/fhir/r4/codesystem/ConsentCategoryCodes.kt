...
enum class ConsentCategoryCodes {
     ...
     * provider in anticipation of potential need for medical treatment. [2005 Honor My
     * Wishes]
     */
    @SerialName("acd")
    ACD,
     ...
     * desire not to have CPR initiated in case of a cardiac event. Note: This form was
     * replaced in 2003 with the Physician Orders for Life-Sustaining Treatment
     * [POLST].
     */
    @SerialName("dnr")
    DNR,
     ...
     * information for purpose of emergency treatment. Additional parameters may
     * further limit the disclosure to specific users, roles, duration, types of
     * information, and impose uses obligations. [ActConsentDirective
    ...
    /**
     * Patient's document telling patient's health care provider what the patient wants
     * or does not want if the patient is diagnosed as being terminally ill and in a
     * persistent vegetative state or in a permanently unconscious condition.[2005
     * Honor My Wishes]
     */
    @SerialName("hcd")
    HCD,
    ...
    /**
     * Acknowledgement of custodian notice of privacy practices. Usage Notes: This type
     * of consent directive acknowledges a custodian's notice of privacy practices
     * including its permitted collection, access, use and disclosure of health
     * information to users and for purposes of use specified. [ActConsentDirective
     * (2.16.840.1.113883.1.11.20425)]
     */
    @SerialName("npp")
    NPP,
    ...
    /**
     * The Physician Order for Life-Sustaining Treatment form records a person's health
     * care wishes for end of life emergency treatment and translates them into an
     * order by the physician. It must be reviewed and signed by both the patient and
     * the physician, Advanced Registered Nurse Practitioner or Physician Assistant.
     * [2005 Honor My Wishes] Comment: Opt-in Consent Directive with restrictions.
     */
    @SerialName("polst")
    POLST,
