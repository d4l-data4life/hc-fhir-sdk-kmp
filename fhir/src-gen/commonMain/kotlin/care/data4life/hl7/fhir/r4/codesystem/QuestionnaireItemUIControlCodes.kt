...
enum class QuestionnaireItemUIControlCodes {
    ...
    /**
     * Text is displayed as a paragraph in a sequential position between sibling items
     * (default behavior)
     */
    @SerialName("inline")
    INLINE,
    ...
    /**
     * Text is displayed adjacent (horizontally or vertically) to the answer space for
     * the parent question, typically to indicate a unit of measure
     */
    @SerialName("unit")
    UNIT,
    ...
    /**
     * Text is temporarily visible over top of an item if the mouse is positioned over
     * top of the text for the containing item
     */
    @SerialName("flyover")
    FLYOVER,
     ...
     * group or the questionnaire as a whole (depending what the text is nested within)
     */
    @SerialName("help")
    HELP,
    ...
    /**
     * A control where an item (or multiple items) can be selected from a list that is
     * only displayed when the user is editing the field.
     */
