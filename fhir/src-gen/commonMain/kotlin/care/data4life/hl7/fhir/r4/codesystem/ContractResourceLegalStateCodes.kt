...
/**
 * Code System: ContractResourceLegalStateCodes
 *
 * This value set contract specific codes for status.
 *
 * @see <a href="http://hl7.org/fhir/contract-legalstate">ContractResourceLegalStateCodes</a>
 * @see <a href="http://hl7.org/fhir/ValueSet/contract-legalstate">ValueSet</a>
 *
 * Generated from FHIR 4.0.1-9346c8cc45
 */
@Serializable
enum class ContractResourceLegalStateCodes {
     ...
     * predecessor Contract. Usage: Contract altered within effective time. Precedence
     * Order = 9. Comparable FHIR and v.3 status codes: updated, replaced.
     */
    @SerialName("appended")
    APPENDED,
     ...
     * contract provision(s). E.g., Grantee complaint about Grantor's failure to comply
     * with contract provisions. Usage: Contract pended. Precedence Order = 7.
     ...
     * on the applicants actual age or smoking status. Usage: Optional contract
     * activity between executable and executed state. Precedence Order = 4. Comparable
     * FHIR and v.3 status codes: in progress; review; held.
     */
     ...
     * competency of the signer(s), or where the policy is substantially different from
     * and did not accompany the application/form so that the applicant could not
     * compare them. Aka - ''reactivated''. Usage: Optional stage where a pended
