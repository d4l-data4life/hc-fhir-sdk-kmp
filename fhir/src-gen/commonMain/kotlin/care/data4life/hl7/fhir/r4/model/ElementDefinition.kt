...
import care.data4life.hl7.fhir.r4.codesystem.AggregationMode
...
import care.data4life.hl7.fhir.r4.codesystem.PropertyRepresentation
import care.data4life.hl7.fhir.r4.codesystem.ReferenceVersionRules
 ...
 */
interface FhirElementDefinition : FhirBackboneElement {
     ...
     * Value must be exactly this.
     */
    val fixedContactDetail: ContactDetail?

    /**
     * Value must be exactly this.
     */
    val fixedContributor: Contributor?

    /**
     * Value must be exactly this.
     */
    val fixedDataRequirement: DataRequirement?
     ...
     * Value must be exactly this.
     */
    val fixedParameterDefinition: ParameterDefinition?

    /**
     * Value must be exactly this.
     */
    val fixedRelatedArtifact: RelatedArtifact?

    /**
     * Value must be exactly this.
     */
    val fixedTriggerDefinition: TriggerDefinition?

    /**
     * Value must be exactly this.
     */
    val fixedUsageContext: UsageContext?

    /**
     * Value must be exactly this.
     */
    val fixedDosage: Dosage?
     ...
     * Value must have at least these property values.
     */
    val patternContactDetail: ContactDetail?

    /**
     * Value must have at least these property values.
     */
    val patternContributor: Contributor?

    /**
     * Value must have at least these property values.
     */
    val patternDataRequirement: DataRequirement?

    /**
     * Value must have at least these property values.
     */
    val patternExpression: Expression?

    /**
     * Value must have at least these property values.
     */
    val patternParameterDefinition: ParameterDefinition?

    /**
     * Value must have at least these property values.
     */
    val patternRelatedArtifact: RelatedArtifact?

    /**
     * Value must have at least these property values.
     */
    val patternTriggerDefinition: TriggerDefinition?

    /**
     * Value must have at least these property values.
     */
    val patternUsageContext: UsageContext?

    /**
     * Value must have at least these property values.
     */
    val patternDosage: Dosage?
...
data class ElementDefinition(
    ...
    @SerialName("sliceIsConstraining")
    override val sliceIsConstraining: Bool? = null,
    ...
    @SerialName("fixedCanonical")
    override val fixedCanonical: String? = null,
    ...
    @SerialName("fixedUrl")
    override val fixedUrl: String? = null,

    @SerialName("fixedUuid")
    override val fixedUuid: String? = null,
    ...
    @SerialName("fixedContactDetail")
    override val fixedContactDetail: ContactDetail? = null,

    @SerialName("fixedContributor")
    override val fixedContributor: Contributor? = null,

    @SerialName("fixedDataRequirement")
    override val fixedDataRequirement: DataRequirement? = null,

    @SerialName("fixedExpression")
    override val fixedExpression: Expression? = null,

    @SerialName("fixedParameterDefinition")
    override val fixedParameterDefinition: ParameterDefinition? = null,

    @SerialName("fixedRelatedArtifact")
    override val fixedRelatedArtifact: RelatedArtifact? = null,

    @SerialName("fixedTriggerDefinition")
    override val fixedTriggerDefinition: TriggerDefinition? = null,

    @SerialName("fixedUsageContext")
    override val fixedUsageContext: UsageContext? = null,

    @SerialName("fixedDosage")
    override val fixedDosage: Dosage? = null,
    ...
    @SerialName("patternCanonical")
    override val patternCanonical: String? = null,
    ...
    @SerialName("patternUrl")
    override val patternUrl: String? = null,

    @SerialName("patternUuid")
    override val patternUuid: String? = null,
    ...
    @SerialName("patternContactDetail")
    override val patternContactDetail: ContactDetail? = null,

    @SerialName("patternContributor")
    override val patternContributor: Contributor? = null,

    @SerialName("patternDataRequirement")
    override val patternDataRequirement: DataRequirement? = null,

    @SerialName("patternExpression")
    override val patternExpression: Expression? = null,

    @SerialName("patternParameterDefinition")
    override val patternParameterDefinition: ParameterDefinition? = null,

    @SerialName("patternRelatedArtifact")
    override val patternRelatedArtifact: RelatedArtifact? = null,

    @SerialName("patternTriggerDefinition")
    override val patternTriggerDefinition: TriggerDefinition? = null,

    @SerialName("patternUsageContext")
    override val patternUsageContext: UsageContext? = null,

    @SerialName("patternDosage")
    override val patternDosage: Dosage? = null,
    ...
    @SerialName("isModifierReason")
    override val isModifierReason: String? = null,
    ...
    companion object {
        @JvmStatic
        fun resourceType(): String = "ElementDefinition"
    }
}
...
data class ElementDefinitionBase(
    ...
    companion object {
        @JvmStatic
        fun resourceType(): String = "ElementDefinitionBase"
    }
}
...
data class ElementDefinitionBinding(
    ...
    companion object {
        @JvmStatic
        fun resourceType(): String = "ElementDefinitionBinding"
    }
}
...
data class ElementDefinitionConstraint(
    ...
    companion object {
        @JvmStatic
        fun resourceType(): String = "ElementDefinitionConstraint"
    }
}
...
data class ElementDefinitionExample(
    ...
    companion object {
        @JvmStatic
        fun resourceType(): String = "ElementDefinitionExample"
    }
}
...
data class ElementDefinitionMapping(
    ...
    companion object {
        @JvmStatic
        fun resourceType(): String = "ElementDefinitionMapping"
    }
}
...
data class ElementDefinitionSlicing(
    ...
    companion object {
        @JvmStatic
        fun resourceType(): String = "ElementDefinitionSlicing"
    }
}
...
data class ElementDefinitionSlicingDiscriminator(
    ...
    companion object {
        @JvmStatic
        fun resourceType(): String = "ElementDefinitionSlicingDiscriminator"
    }
}
...
data class ElementDefinitionType(
    ...
    companion object {
        @JvmStatic
        fun resourceType(): String = "ElementDefinitionType"
    }
}
