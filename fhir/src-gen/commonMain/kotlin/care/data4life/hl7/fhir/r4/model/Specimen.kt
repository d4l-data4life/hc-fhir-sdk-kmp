...
interface FhirSpecimen : FhirDomainResource {
     ...
     */
    val condition: List<CodeableConcept>?
...
data class Specimen(
    ...
    companion object {
        @JvmStatic
        fun resourceType(): String = "Specimen"
    }
}
...
interface FhirSpecimenCollection : FhirBackboneElement {
     ...
     */
    val fastingStatusCodeableConcept: CodeableConcept?

    /**
     * Whether or how long patient abstained from food and/or drink.
     */
    val fastingStatusDuration: Duration?
}
...
data class SpecimenCollection(
    ...
    companion object {
        @JvmStatic
        fun resourceType(): String = "SpecimenCollection"
    }
}
...
data class SpecimenContainer(
    ...
    companion object {
        @JvmStatic
        fun resourceType(): String = "SpecimenContainer"
    }
}
...
data class SpecimenProcessing(
    ...
    companion object {
        @JvmStatic
        fun resourceType(): String = "SpecimenProcessing"
    }
}
