...
data class ConceptMap(
    ...
    @SerialName("sourceCanonical")
    override val sourceCanonical: String? = null,

    @SerialName("targetUri")
    override val targetUri: String? = null,

    @SerialName("targetCanonical")
    override val targetCanonical: String? = null,
    ...
    companion object {
        @JvmStatic
        fun resourceType(): String = "ConceptMap"
    }
}
...
data class ConceptMapGroup(
    ...
    companion object {
        @JvmStatic
        fun resourceType(): String = "ConceptMapGroup"
    }
}
...
data class ConceptMapGroupElement(
    ...
    companion object {
        @JvmStatic
        fun resourceType(): String = "ConceptMapGroupElement"
    }
}
...
data class ConceptMapGroupElementTarget(
    ...
    override val equivalence: ConceptMapEquivalence,
    ...
    companion object {
        @JvmStatic
        fun resourceType(): String = "ConceptMapGroupElementTarget"
    }
}
...
data class ConceptMapGroupElementTargetDependsOn(
    ...
    companion object {
        @JvmStatic
        fun resourceType(): String = "ConceptMapGroupElementTargetDependsOn"
    }
}
 ...
 * are unmatched, and the unmapped element is ignored in a code is specified to have equivalence =
 * unmatched.
 *
...
data class ConceptMapGroupUnmapped(
    ...
    companion object {
        @JvmStatic
        fun resourceType(): String = "ConceptMapGroupUnmapped"
    }
}
