...
enum class MatchGrade {
    ...
    /**
     * This record meets the matching criteria to be automatically considered as a full
     * match.
     */
    @SerialName("certain")
    CERTAIN,
     ...
     * are not returned, but in some cases records previously or likely considered as a
