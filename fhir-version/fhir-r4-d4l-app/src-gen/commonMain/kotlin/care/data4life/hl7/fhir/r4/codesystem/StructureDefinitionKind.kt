...
enum class StructureDefinitionKind {
     ...
     * complex datatype, Resource and extension definitions. Only the base
    ...
    /**
     * A complex structure that defines a set of data elements that is suitable for use
     * in 'resources'. The base specification defines a number of complex types, and
     * other specifications can define additional types. These structures do not have a
     * maintained identity.
     */
    ...
    /**
     * A 'resource' - a directed acyclic graph of elements that aggregrates other types
     * into an identifiable entity. The base FHIR resources are defined by the FHIR
     * specification itself but other 'resources' can be defined in additional
