...
data class NutritionOrder(
    ...
    companion object {
        @JvmStatic
        fun resourceType(): String = "NutritionOrder"
    }
}
...
data class NutritionOrderEnteralFormula(
    ...
    companion object {
        @JvmStatic
        fun resourceType(): String = "NutritionOrderEnteralFormula"
    }
}
...
data class NutritionOrderEnteralFormulaAdministration(
    ...
    companion object {
        @JvmStatic
        fun resourceType(): String = "NutritionOrderEnteralFormulaAdministration"
    }
}
...
data class NutritionOrderOralDiet(
    ...
    companion object {
        @JvmStatic
        fun resourceType(): String = "NutritionOrderOralDiet"
    }
}
...
data class NutritionOrderOralDietNutrient(
    ...
    companion object {
        @JvmStatic
        fun resourceType(): String = "NutritionOrderOralDietNutrient"
    }
}
...
data class NutritionOrderOralDietTexture(
    ...
    companion object {
        @JvmStatic
        fun resourceType(): String = "NutritionOrderOralDietTexture"
    }
}
...
data class NutritionOrderSupplement(
    ...
    companion object {
        @JvmStatic
        fun resourceType(): String = "NutritionOrderSupplement"
    }
}
