...
interface FhirDetectedIssue : FhirDomainResource {
     ...
     * When identified.
     */
    val identifiedDateTime: DateTime?

    /**
     * When identified.
     */
    val identifiedPeriod: Period?
     ...
     * Supporting evidence.
     */
    val evidence: kotlin.collections.List<DetectedIssueEvidence>?
...
data class DetectedIssue(
    ...
    @SerialName("identifiedDateTime")
    override val identifiedDateTime: DateTime? = null,

    @SerialName("identifiedPeriod")
    override val identifiedPeriod: Period? = null,
    ...
    @SerialName("evidence")
    override val evidence: kotlin.collections.List<DetectedIssueEvidence>? = null,
    ...
    companion object {
        @JvmStatic
        fun resourceType(): String = "DetectedIssue"
    }
}
 ...
 *
 * @see <a href="http://hl7.org/fhir/StructureDefinition/DetectedIssue">DetectedIssueEvidence</a>
 *
 * Generated from FHIR 4.0.1-9346c8cc45 (http://hl7.org/fhir/StructureDefinition/DetectedIssue)
 */
interface FhirDetectedIssueEvidence : FhirBackboneElement {
...
data class DetectedIssueEvidence(
    ...
    companion object {
        @JvmStatic
        fun resourceType(): String = "DetectedIssueEvidence"
    }
}
...
data class DetectedIssueMitigation(
    ...
    companion object {
        @JvmStatic
        fun resourceType(): String = "DetectedIssueMitigation"
    }
}
