...
interface FhirGraphDefinition : FhirDomainResource {
    ...
    /**
     * Canonical identifier for this graph definition, represented as a URI (globally
     * unique).
     */
    val url: String?
...
data class GraphDefinition(
    ...
    companion object {
        @JvmStatic
        fun resourceType(): String = "GraphDefinition"
    }
}
...
data class GraphDefinitionLink(
    ...
    @SerialName("target")
    override val target: kotlin.collections.List<GraphDefinitionLinkTarget>? = null,
    ...
    companion object {
        @JvmStatic
        fun resourceType(): String = "GraphDefinitionLink"
    }
}
...
data class GraphDefinitionLinkTarget(
    ...
    companion object {
        @JvmStatic
        fun resourceType(): String = "GraphDefinitionLinkTarget"
    }
}
...
data class GraphDefinitionLinkTargetCompartment(
    ...
    @SerialName("use")
    override val use: GraphCompartmentUse,
    ...
    companion object {
        @JvmStatic
        fun resourceType(): String = "GraphDefinitionLinkTargetCompartment"
    }
}
