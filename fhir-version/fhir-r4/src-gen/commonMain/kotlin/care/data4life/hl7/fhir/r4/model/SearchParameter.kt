...
interface FhirSearchParameter : FhirDomainResource {
    ...
    /**
     * Canonical identifier for this search parameter, represented as a URI (globally
     * unique).
     */
    val url: String
...
data class SearchParameter(
    ...
    @SerialName("multipleOr")
    override val multipleOr: Bool? = null,

    @SerialName("multipleAnd")
    override val multipleAnd: Bool? = null,
    ...
    companion object {
        @JvmStatic
        fun resourceType(): String = "SearchParameter"
    }
}
...
data class SearchParameterComponent(
    ...
    companion object {
        @JvmStatic
        fun resourceType(): String = "SearchParameterComponent"
    }
}
