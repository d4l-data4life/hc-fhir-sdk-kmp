...
interface FhirRelatedPerson : FhirDomainResource {
     ...
     */
    val communication: kotlin.collections.List<RelatedPersonCommunication>?
}
...
data class RelatedPerson(
    ...
    override val communication: kotlin.collections.List<RelatedPersonCommunication>? = null,
    ...
    companion object {
        @JvmStatic
        fun resourceType(): String = "RelatedPerson"
    }
}
 ...
 * A language which may be used to communicate with about the patient's health
 *
 * @see <a href="http://hl7.org/fhir/StructureDefinition/RelatedPerson">RelatedPersonCommunication</a>
 *
 * Generated from FHIR 4.0.1-9346c8cc45 (http://hl7.org/fhir/StructureDefinition/RelatedPerson)
 */
interface FhirRelatedPersonCommunication : FhirBackboneElement {
...
data class RelatedPersonCommunication(
    ...
    companion object {
        @JvmStatic
        fun resourceType(): String = "RelatedPersonCommunication"
    }
}
