...
class TestScriptFhirTest {
    ...
    fun testTestScript01() {
        // Given
        val sourceJson = loadAsString("r4/testscript-example-multisystem.json")
    ...
    private fun assertTestScript01Step01(data: TestScript) {
        ...
        assertEquals(
            ...
            actual = data.metadata?.capability?.get(0)?.capabilities
                ?.replace("\\n", " ")
        )
        ...
        assertEquals(
            expected = "CapabilityStatement/example",
            actual = data.metadata?.capability?.get(1)?.capabilities
                ?.replace("\\n", " ")
        )
        ...
        assertEquals(
            expected = "http://terminology.hl7.org/CodeSystem/testscript-operation-codes",
        ...
        assertEquals(
            expected = "False".toBoolean(),
            actual = data.test?.get(0)?.action?.get(1)?.assert?.warningOnly?.value
        )
        ...
        assertEquals(
            expected = "False".toBoolean(),
            actual = data.test?.get(0)?.action?.get(4)?.assert?.warningOnly?.value
        )
        ...
        assertEquals(
            expected = "False".toBoolean(),
            actual = data.test?.get(0)?.action?.get(5)?.assert?.warningOnly?.value
        )
        ...
        assertEquals(
            expected = "True".toBoolean(),
            actual = data.test?.get(1)?.action?.get(0)?.operation?.encodeRequestUrl?.value
        )
        ...
        assertEquals(
            expected = "False".toBoolean(),
            actual = data.test?.get(1)?.action?.get(1)?.assert?.warningOnly?.value
        )
        ...
        assertEquals(
            expected = "False".toBoolean(),
            actual = data.test?.get(1)?.action?.get(2)?.assert?.warningOnly?.value
        )
        ...
        assertEquals(
            expected = "False".toBoolean(),
            actual = data.test?.get(1)?.action?.get(3)?.assert?.warningOnly?.value
        )
    }
    ...
    private fun assertTestScript01Step02(data: TestScript) {
        ...
        assertEquals(
            expected = "False".toBoolean(),
            actual = data.test?.get(1)?.action?.get(4)?.assert?.warningOnly?.value
        )
    ...
    fun testTestScript02() {
        // Given
        val sourceJson = loadAsString("r4/testscript-example-history.json")
    ...
    private fun assertTestScript02Step01(data: TestScript) {
        ...
        assertEquals(
            expected = "True".toBoolean(),
            actual = data.setup?.action?.get(0)?.operation?.encodeRequestUrl?.value
        )
        ...
        assertEquals(
            expected = "False".toBoolean(),
            actual = data.setup?.action?.get(1)?.assert?.warningOnly?.value
        )
        ...
        assertEquals(
            expected = "True".toBoolean(),
            actual = data.setup?.action?.get(2)?.operation?.encodeRequestUrl?.value
        )
        ...
        assertEquals(
            expected = "False".toBoolean(),
            actual = data.setup?.action?.get(3)?.assert?.warningOnly?.value
        )
        ...
        assertEquals(
            expected = "True".toBoolean(),
            actual = data.setup?.action?.get(4)?.operation?.encodeRequestUrl?.value
        )
        ...
        assertEquals(
            expected = "False".toBoolean(),
            actual = data.setup?.action?.get(5)?.assert?.warningOnly?.value
        )
    ...
    fun testTestScript03() {
        // Given
        val sourceJson = loadAsString("r4/testscript-example-update.json")
    ...
    private fun assertTestScript03Step01(data: TestScript) {
        ...
        assertEquals(
            expected = "Confirm that the returned HTTP Header Last-Modified is present. Warning only as the server might not support versioning.",
            actual = data.test?.get(0)?.action?.get(3)?.assert?.description
                ?.replace("\\n", " ")
        )
    ...
    fun testTestScript04() {
        // Given
        val sourceJson = loadAsString("r4/testscript-example-search.json")
    ...
    private fun assertTestScript04Step01(data: TestScript) {
        ...
        assertEquals(
            expected = "False".toBoolean(),
            actual = data.setup?.action?.get(2)?.assert?.warningOnly?.value
        )
        ...
        assertEquals(
            expected = "False".toBoolean(),
            actual = data.setup?.action?.get(4)?.assert?.warningOnly?.value
        )
        ...
        assertEquals(
            expected = "True".toBoolean(),
            actual = data.test?.get(0)?.action?.get(3)?.operation?.encodeRequestUrl?.value
        )
    ...
    private fun assertTestScript04Step02(data: TestScript) {
        ...
        assertEquals(
            expected = "False".toBoolean(),
            actual = data.test?.get(1)?.action?.get(5)?.assert?.warningOnly?.value
        )
        ...
        assertEquals(
            expected = "False".toBoolean(),
            actual = data.test?.get(1)?.action?.get(6)?.assert?.warningOnly?.value
        )
    ...
    fun testTestScript05() {
        // Given
        val sourceJson = loadAsString("r4/testscript-example.json")
    ...
    private fun assertTestScript05Step01(data: TestScript) {
        ...
        assertEquals(
            expected = "False".toBoolean(),
            actual = data.setup?.action?.get(6)?.assert?.warningOnly?.value
        )
        ...
        assertEquals(
            expected = "True".toBoolean(),
            actual = data.teardown?.action?.get(0)?.operation?.encodeRequestUrl?.value
        )
    ...
    private fun assertTestScript05Step02(data: TestScript) {
        ...
        assertEquals(
            expected = "False".toBoolean(),
            actual = data.test?.get(0)?.action?.get(6)?.assert?.warningOnly?.value
        )
        ...
        assertEquals(
            expected = "False".toBoolean(),
            actual = data.test?.get(0)?.action?.get(7)?.assert?.warningOnly?.value
        )
        ...
        assertEquals(
            expected = "False".toBoolean(),
            actual = data.test?.get(0)?.action?.get(8)?.assert?.warningOnly?.value
        )
    ...
    fun testTestScript06() {
        // Given
        val sourceJson = loadAsString("r4/testscript-example-readtest.json")
    ...
    private fun assertTestScript06Step01(data: TestScript) {
        ...
        assertEquals(
            expected = "True".toBoolean(),
            actual = data.test?.get(2)?.action?.get(0)?.operation?.encodeRequestUrl?.value
        )
        ...
        assertEquals(
            expected = "False".toBoolean(),
            actual = data.test?.get(2)?.action?.get(1)?.assert?.warningOnly?.value
        )
        ...
        assertEquals(
            expected = "True".toBoolean(),
            actual = data.test?.get(3)?.action?.get(0)?.operation?.encodeRequestUrl?.value
        )
        ...
        assertEquals(
            expected = "False".toBoolean(),
            actual = data.test?.get(3)?.action?.get(1)?.assert?.warningOnly?.value
        )
