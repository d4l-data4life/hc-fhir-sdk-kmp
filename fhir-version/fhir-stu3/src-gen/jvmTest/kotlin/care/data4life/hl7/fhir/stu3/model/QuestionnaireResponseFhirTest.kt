...
class QuestionnaireResponseFhirTest {
    ...
    private fun assertQuestionnaireResponse02Step01(data: QuestionnaireResponse) {
        ...
        assertEquals(
            expected = "LA10405-1",
            actual = data.item?.get(2)?.item?.get(0)?.item?.get(0)?.item?.get(0)?.answer?.get(0)?.valueCoding?.code
                ?.replace("\\n", " ")
        )

        assertEquals(
            expected = "Daughter",
            actual = data.item?.get(2)?.item?.get(0)?.item?.get(0)?.item?.get(0)?.answer?.get(0)?.valueCoding?.display
                ?.replace("\\n", " ")
        )

        assertEquals(
            expected = "http://loinc.org",
            actual = data.item?.get(2)?.item?.get(0)?.item?.get(0)?.item?.get(0)?.answer?.get(0)?.valueCoding?.system
                ?.replace("\\n", " ")
        )

        assertEquals(
            expected = "http://loinc.org/fhir/DataElement/54136-7",
            actual = data.item?.get(2)?.item?.get(0)?.item?.get(0)?.item?.get(0)?.definition
                ?.replace("\\n", " ")
        )

        assertEquals(
            expected = "2.1.1.1",
            actual = data.item?.get(2)?.item?.get(0)?.item?.get(0)?.item?.get(0)?.linkId
                ?.replace("\\n", " ")
        )

        assertEquals(
            expected = "Relationship to you",
            actual = data.item?.get(2)?.item?.get(0)?.item?.get(0)?.item?.get(0)?.text
                ?.replace("\\n", " ")
        )

        assertEquals(
            expected = "Susan",
            actual = data.item?.get(2)?.item?.get(0)?.item?.get(0)?.item?.get(1)?.answer?.get(0)?.valueString
                ?.replace("\\n", " ")
        )

        assertEquals(
            expected = "http://loinc.org/fhir/DataElement/54138-3",
            actual = data.item?.get(2)?.item?.get(0)?.item?.get(0)?.item?.get(1)?.definition
                ?.replace("\\n", " ")
        )

        assertEquals(
            expected = "2.1.1.2",
            actual = data.item?.get(2)?.item?.get(0)?.item?.get(0)?.item?.get(1)?.linkId
                ?.replace("\\n", " ")
        )

        assertEquals(
            expected = "Name",
            actual = data.item?.get(2)?.item?.get(0)?.item?.get(0)?.item?.get(1)?.text
                ?.replace("\\n", " ")
        )

        assertEquals(
            expected = "LA3-6",
            actual = data.item?.get(2)?.item?.get(0)?.item?.get(0)?.item?.get(2)?.answer?.get(0)?.valueCoding?.code
                ?.replace("\\n", " ")
        )

        assertEquals(
            expected = "Female",
            actual = data.item?.get(2)?.item?.get(0)?.item?.get(0)?.item?.get(2)?.answer?.get(0)?.valueCoding?.display
                ?.replace("\\n", " ")
        )

        assertEquals(
            expected = "http://loinc.org",
            actual = data.item?.get(2)?.item?.get(0)?.item?.get(0)?.item?.get(2)?.answer?.get(0)?.valueCoding?.system
                ?.replace("\\n", " ")
        )

        assertEquals(
            expected = "http://loinc.org/fhir/DataElement/54123-5",
            actual = data.item?.get(2)?.item?.get(0)?.item?.get(0)?.item?.get(2)?.definition
                ?.replace("\\n", " ")
        )

        assertEquals(
            expected = "2.1.1.3",
            actual = data.item?.get(2)?.item?.get(0)?.item?.get(0)?.item?.get(2)?.linkId
                ?.replace("\\n", " ")
        )

        assertEquals(
            expected = "Gender",
            actual = data.item?.get(2)?.item?.get(0)?.item?.get(0)?.item?.get(2)?.text
                ?.replace("\\n", " ")
        )

        assertEquals(
            expected = "17".toDouble(),
            actual = data.item?.get(2)?.item?.get(0)?.item?.get(0)?.item?.get(3)?.answer?.get(0)?.item?.get(0)?.item?.get(0)?.answer?.get(0)?.valueDecimal?.value
        )

        assertEquals(
            expected = "http://loinc.org/fhir/DataElement/54141-7",
            actual = data.item?.get(2)?.item?.get(0)?.item?.get(0)?.item?.get(3)?.answer?.get(0)?.item?.get(0)?.item?.get(0)?.definition
                ?.replace("\\n", " ")
        )

        assertEquals(
            expected = "2.1.1.4.2.2",
            actual = data.item?.get(2)?.item?.get(0)?.item?.get(0)?.item?.get(3)?.answer?.get(0)?.item?.get(0)?.item?.get(0)?.linkId
                ?.replace("\\n", " ")
        )

        assertEquals(
            expected = "Age",
            actual = data.item?.get(2)?.item?.get(0)?.item?.get(0)?.item?.get(3)?.answer?.get(0)?.item?.get(0)?.item?.get(0)?.text
                ?.replace("\\n", " ")
        )

        assertEquals(
            expected = "2.1.1.4.2",
            actual = data.item?.get(2)?.item?.get(0)?.item?.get(0)?.item?.get(3)?.answer?.get(0)?.item?.get(0)?.linkId
                ?.replace("\\n", " ")
        )

        assertEquals(
            expected = "LA33-6",
            actual = data.item?.get(2)?.item?.get(0)?.item?.get(0)?.item?.get(3)?.answer?.get(0)?.valueCoding?.code
                ?.replace("\\n", " ")
        )

        assertEquals(
            expected = "Yes",
            actual = data.item?.get(2)?.item?.get(0)?.item?.get(0)?.item?.get(3)?.answer?.get(0)?.valueCoding?.display
                ?.replace("\\n", " ")
        )

        assertEquals(
            expected = "http://loinc.org",
            actual = data.item?.get(2)?.item?.get(0)?.item?.get(0)?.item?.get(3)?.answer?.get(0)?.valueCoding?.system
                ?.replace("\\n", " ")
        )

        assertEquals(
            expected = "http://loinc.org/fhir/DataElement/54139-1",
            actual = data.item?.get(2)?.item?.get(0)?.item?.get(0)?.item?.get(3)?.definition
                ?.replace("\\n", " ")
        )

        assertEquals(
            expected = "2.1.1.4",
            actual = data.item?.get(2)?.item?.get(0)?.item?.get(0)?.item?.get(3)?.linkId
                ?.replace("\\n", " ")
        )

        assertEquals(
            expected = "Living?",
            actual = data.item?.get(2)?.item?.get(0)?.item?.get(0)?.item?.get(3)?.text
                ?.replace("\\n", " ")
        )
    }
    ...
    private fun assertQuestionnaireResponse02Step02(data: QuestionnaireResponse) {
        assertEquals(
            expected = "LA32-8",
            actual = data.item?.get(2)?.item?.get(0)?.item?.get(0)?.item?.get(4)?.answer?.get(0)?.valueCoding?.code
                ?.replace("\\n", " ")
        )

        assertEquals(
            expected = "No",
            actual = data.item?.get(2)?.item?.get(0)?.item?.get(0)?.item?.get(4)?.answer?.get(0)?.valueCoding?.display
                ?.replace("\\n", " ")
        )

        assertEquals(
            expected = "http://loinc.org",
            actual = data.item?.get(2)?.item?.get(0)?.item?.get(0)?.item?.get(4)?.answer?.get(0)?.valueCoding?.system
                ?.replace("\\n", " ")
        )

        assertEquals(
            expected = "http://loinc.org/fhir/DataElement/54121-9",
            actual = data.item?.get(2)?.item?.get(0)?.item?.get(0)?.item?.get(4)?.definition
                ?.replace("\\n", " ")
        )

        assertEquals(
            expected = "2.1.1.5",
            actual = data.item?.get(2)?.item?.get(0)?.item?.get(0)?.item?.get(4)?.linkId
                ?.replace("\\n", " ")
        )

        assertEquals(
            expected = "Was this person born a twin?",
            actual = data.item?.get(2)?.item?.get(0)?.item?.get(0)?.item?.get(4)?.text
                ?.replace("\\n", " ")
        )

        assertEquals(
            expected = "LA32-8",
            actual = data.item?.get(2)?.item?.get(0)?.item?.get(0)?.item?.get(5)?.answer?.get(0)?.valueCoding?.code
                ?.replace("\\n", " ")
        )

        assertEquals(
            expected = "No",
            actual = data.item?.get(2)?.item?.get(0)?.item?.get(0)?.item?.get(5)?.answer?.get(0)?.valueCoding?.display
                ?.replace("\\n", " ")
        )

        assertEquals(
            expected = "http://loinc.org",
            actual = data.item?.get(2)?.item?.get(0)?.item?.get(0)?.item?.get(5)?.answer?.get(0)?.valueCoding?.system
                ?.replace("\\n", " ")
        )

        assertEquals(
            expected = "http://loinc.org/fhir/DataElement/54122-7",
            actual = data.item?.get(2)?.item?.get(0)?.item?.get(0)?.item?.get(5)?.definition
                ?.replace("\\n", " ")
        )

        assertEquals(
            expected = "2.1.1.6",
            actual = data.item?.get(2)?.item?.get(0)?.item?.get(0)?.item?.get(5)?.linkId
                ?.replace("\\n", " ")
        )

        assertEquals(
            expected = "Was this person adopted?",
            actual = data.item?.get(2)?.item?.get(0)?.item?.get(0)?.item?.get(5)?.text
                ?.replace("\\n", " ")
        )
    ...
    private fun assertQuestionnaireResponse02Step06(data: QuestionnaireResponse) {
        ...
        assertEquals(
            ...
            actual = data.item?.get(2)?.subject?.reference
                ?.replace("\\n", " ")
        )
        ...
        assertEquals(
            ...
            actual = data.questionnaire?.reference
                ?.replace("\\n", " ")
        )
    ...
    private fun assertQuestionnaireResponse05Step01(data: QuestionnaireResponse) {
        ...
        assertEquals(
            expected = "http://hl7.org/fhir/StructureDefinition/iso21090-CO-value",
