...
class CommunicationRequestFhirTest {
    ...
    fun testCommunicationRequest01() {
        // Given
        val sourceJson = loadAsString("stu3/communicationrequest-example.json")
    ...
    fun testCommunicationRequest02() {
        // Given
        val sourceJson = loadAsString("stu3/communicationrequest-example-fm-solicit-attachment.json")
