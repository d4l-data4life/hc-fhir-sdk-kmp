...
class ScheduleFhirTest {
    ...
    fun testSchedule01() {
        // Given
        val sourceJson = loadAsString("stu3/schedule-provider-location1-example.json")
    ...
    fun testSchedule02() {
        // Given
        val sourceJson = loadAsString("stu3/schedule-example.json")
    ...
    fun testSchedule03() {
        // Given
        val sourceJson = loadAsString("stu3/schedule-provider-location2-example.json")
